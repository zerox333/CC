...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	self.loginView = tmpLoginView;
	[tmpLoginView release];
	
	UINavigationController *tmpNav = [[UINavigationController alloc] initWithRootViewController:loginView];
	self.navController = tmpNav;
	[tmpNav release];
	
    if ([navController.navigationBar respondsToSelector:@selector(setBackgroundImage:forBarMetrics:)])
    {
        UIImage *navImage = [UIImage imageNamed:@"nav_background.png"];
